...
var Z = function Z() {
  ...
  var label = function label(_label, guid) {
    return (0, _litHtml.html)(_templateObject(), guid, _label);
  };
  /**
   * 验证表单方法
   * @access private
  ...
  var validate = function validate(_ref, rule) {
    var parent = _ref.parentElement,
        value = _ref.value;
    var message = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "靓仔，你这个不能空着啊！";
    ...
    switch (rule) {
      ...
      default:
        throw new Error("\u5C1A\u672A\u5B9A\u4E49 ".concat(rule, " \u7C7B\u578B\u7684\u6821\u9A8C\u89C4\u5219\uFF01"));
    }
  };
  ...
  var select = function select(_ref2) {
    ...
    return (0, _litHtml.html)(_templateObject2(), name && label(name, guid), change, guid, guid, tags.map(function (tag) {
      return (0, _litHtml.html)(_templateObject3(), tag, tag);
    }));
  };
  ...
  var input = function input(_ref4) {
    ...
    var blur = function blur(_ref5) {
      var target = _ref5.target;
      validate(target, RULES.REQUIRED);
    };

    return (0, _litHtml.html)(_templateObject4(), name && label(name, guid), suffix ? suffix : "", blur, guid, guid, type.toLowerCase() === "input" ? "text" : type);
  };
  ...
  var checkbox = function checkbox(_ref6) {
    var friends = _ref6.friends;

    var units = function units(_ref7) {
      var id = _ref7.id,
          name = _ref7.name;
      return (0, _litHtml.html)(_templateObject5(), id, id, name && label(name, id));
    };

    return (0, _litHtml.html)(_templateObject6(), Array.isArray(friends) ? friends.map(function (friend) {
      return (0, _litHtml.html)(_templateObject7(), friends.length, units(friend));
    }) : units(friends));
  };
...
var form = function form(_ref8) {
  var data = _ref8.data,
      ...
      onSubmit = _ref8$onSubmit === void 0 ? function (formData) {
    return console.log(formData);
  } : _ref8$onSubmit;
  var inputs = Z();

  var submit = function submit(_ref9) {
    var preventDefault = _ref9.preventDefault,
        target = _ref9.target;
    preventDefault();
  ...
  return (0, _litHtml.html)(_templateObject8(), id, submit, data.map(function (input) {
    return inputs[input.type](input);
  }));
};

(0, _litHtml.render)(form({
  data: _MOCK.MOCK,
  id: "signup"
}), document.getElementById("root"));
},{"lit-html":"../node_modules/lit-html/lit-html.js","./MOCK.js":"MOCK.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
